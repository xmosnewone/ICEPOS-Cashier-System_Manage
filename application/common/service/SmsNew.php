...
/**
 * 腾讯新版3.0发送短信类
 * 要安装证书: cacert.pem (在extend\TencentCloud下面)
 * 编辑php.ini文件，删除curl.cainfo配置项前的分号注释符（;），值设置为保存的证书文件cacert.pem的绝对路径。
 * 例如: curl.cainfo ="E:/wamp/bin/php/php7.2.4/cacert.pem"
 */
	...
	public function sendSms(){
		try {
			...
			* sms helper: https://cloud.tencent.com/document/product/382/3773 */
			...
			$req->PhoneNumberSet = array("+8615813640433");
			/* 国际/港澳台短信 senderid: 国内短信填空，默认未开通，如需开通请联系 [sms helper] */
			$req->SenderId = "";
			/* 用户的 session 内容: 可以携带用户侧 ID 等上下文信息，server 会原样返回 */
			$req->SessionContext = "test";
			/* 模板 ID: 必须填写已审核通过的模板 ID。模板ID可登录 [短信控制台] 查看 */
			$req->TemplateID = "294242";
			/* 模板参数: 若无模板参数，则设置为空--这里就是{1}{2}等的替换内容*/
