...
return array(
    ...
    'pi_check_not_approve'=>'审核的单据必须是未审核的单据',
    'pi_check_fail'=>'采购单审核失败',
    'pi_delete_not_approve'=>'删除的单据必须是未审核的单据',
    ...
    'gf_cant_use'=>'不可用',
    'gf_is_used'=>'已使用',
    'gf_delete_success'=>'优惠券分类删除成功',
    'gf_has_coupon'=>'分类下还有优惠券票据,请先删除',
    ...
    //退款
    'payflow_empty'=>'订单支付流水不存在',
    'refund_success'=>'退款成功',
    'refund_error'=>'退款失败',
    'payinfo_notexist'=>'支付记录不存在',
    'payway_error'=>'非可退款的支付方式',
    'refund_done'=>'已退款',
    'wechat_service_lack'=>'微信商户信息未配置',
    'wechat_tansno_wrong'=>'微信订单号不正确',
    'wechat_refund_error'=>'执行微信退款报错',
    'wechat_refund_success'=>'执行微信退款成功',
    'wechat_refund_fail'=>'执行微信退款失败',
    'alipay_service_lack'=>'支付宝商户信息未配置',
    'alipay_refund_success'=>'执行支付宝退款成功',
    'alipay_refund_fail'=>'执行支付宝退款失败',
);
?>